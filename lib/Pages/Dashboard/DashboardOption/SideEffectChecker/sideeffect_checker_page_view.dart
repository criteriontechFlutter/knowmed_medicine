                                       ...
                                       // height: 200,
                                        ...
                                        child: Column(
                                         ...
                                         child: ListView.separated(
                                                  padding: const EdgeInsets.symmetric(vertical: 0,horizontal: 5),itemBuilder: (BuildContext context, int index){
                                                return Container(
                                                  padding: const EdgeInsets.all(10),
                                                  decoration: BoxDecoration(
                                                    borderRadius: BorderRadius.circular(10),
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: ListView.separated(
                                                  ...
                                                  padding: EdgeInsets.symmetric(vertical: 0,horizontal: 5),itemBuilder: (BuildContext context, int index){
                                                return Container(
