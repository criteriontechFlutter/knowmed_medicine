...
class _MedicineDetailsState extends State<MedicineDetails> {
  ...
  MedicineDetailsModal modal= MedicineDetailsModal();
  MedicineModal medicine_Modal=MedicineModal();
    ...
    @override
  get() async {
    await modal.medicineDetails(context,widget.index);
  }
  ...
  Widget _getWidgetAccordingToType(MedicineDetailsDataModal medicine){
