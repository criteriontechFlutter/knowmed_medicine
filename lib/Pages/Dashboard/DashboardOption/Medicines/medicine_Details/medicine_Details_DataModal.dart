...
class MedicineDetailsDataModal {
  String? headingId;
  String? heading;
  dynamic body;
  String? reference;
  ...
  MedicineDetailsDataModal({this.headingId, this.heading, this.body, this.reference, this.imagePath});

  MedicineDetailsDataModal.fromJson(Map<String, dynamic> json) {
