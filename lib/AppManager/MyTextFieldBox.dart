...
class MyTextFieldBox extends StatefulWidget {
  ...
  List<TextInputFormatter>? inputFormatters;
   ...
   MyTextFieldBox({Key? key, this.hintText, this.controller,
  ...
  @override
  _MyTextFieldBoxState createState() => _MyTextFieldBoxState();
}

class _MyTextFieldBoxState extends State<MyTextFieldBox> {
